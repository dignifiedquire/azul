...
use azul_css::{
    ...
    CssRuleBlock, DynamicCssProperty, NodeTypePath, NodeTypePathParseError, Stylesheet,
};
        ...
        match token {
            ...
            Token::TypeSelector(div_type) => {
                ...
                last_path.push(CssPathSelector::Type(
                    NodeTypePath::from_str(div_type).map_err(|e| CssParseError {
                        css_string,
                        error: e.into(),
                        location: (last_error_location, get_error_location(tokenizer)),
                    })?,
    ...
    fn test_apply_css_pure_class() {
        ...
        // Simple example
        {
            ...
            let expected_rules = vec![CssRuleBlock {
                path: CssPath {
                    selectors: vec![CssPathSelector::Class("my_class".into())],
                },
        ...
        // Slightly more complex example
        {
            ...
            let expected_rules = vec![
                CssRuleBlock {
                    path: CssPath {
                        selectors: vec![CssPathSelector::Id("my_id".into())],
                    },
                    declarations: vec![CssDeclaration::Static(red.clone())],
                },
                CssRuleBlock {
        ...
        // Even more complex example
        {
            ...
            let expected_rules = vec![
                CssRuleBlock {
                    path: CssPath {
                        selectors: vec![CssPathSelector::Global],
                    },
                ...
                CssRuleBlock {
                    path: CssPath {
                        selectors: vec![
                            CssPathSelector::Class("my_class".into()),
                            CssPathSelector::Id("my_id".into()),
                        ],
                    },
                    declarations: vec![CssDeclaration::Static(red.clone())],
                },
...
fn test_multiple_rules() {
    ...
    let expected_rules = vec![
        ...
        CssRuleBlock {
            path: CssPath {
                selectors: vec![Global, Type(NodeTypePath::Div), Id("my_id".into())],
            },
            declarations: Vec::new(),
        },
        CssRuleBlock {
    ...
    assert_eq!(
        parsed_css,
        Css {
            stylesheets: vec![expected_rules.into()]
        }
    );
}
...
fn test_case_issue_93() {
    ...
    let expected_rules = vec![
        declaration(
            &[Class("tabwidget-tab-label".into())],
            ColorU {
                r: 255,
                g: 255,
                b: 255,
