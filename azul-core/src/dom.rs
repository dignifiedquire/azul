...
use crate::{
    ...
    callbacks::{
        ...
        IFrameCallback, IFrameCallbackTypeUnchecked, StackCheckedPointer,
    },
...
fn node_data_to_string<T>(node_data: &NodeData<T>) -> String {
    ...
    format!(
        "{}{}{}{}{}{}{}",
        id_string, class_string, tabindex, draggable, callbacks, default_callbacks, css_overrides
    )
}
...
impl<T> NodeData<T> {
    ...
    pub fn has_class(&self, class: &str) -> bool {
        self.classes
            .iter()
            .any(|self_class| self_class.equals_str(class))
    }
    ...
    #[inline(always)]
    pub const fn get_node_type(&self) -> &NodeType<T> {
        &self.node_type
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn get_callbacks(&self) -> &Vec<(EventFilter, Callback<T>)> {
        &self.callbacks
    }
    #[inline(always)]
    pub const fn get_default_callback_ids(&self) -> &Vec<(EventFilter, DefaultCallbackId)> {
        &self.default_callback_ids
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn set_node_type(&mut self, node_type: NodeType<T>) {
    ...
    #[inline(always)]
    pub fn set_callbacks(&mut self, callbacks: Vec<(EventFilter, Callback<T>)>) {
        self.callbacks = callbacks;
    }
    #[inline(always)]
    pub fn set_default_callback_ids(
        &mut self,
        default_callback_ids: Vec<(EventFilter, DefaultCallbackId)>,
    ) {
        self.default_callback_ids = default_callback_ids;
    }
    #[inline(always)]
    pub fn set_dynamic_css_overrides(
        ...
        self.dynamic_css_overrides = dynamic_css_overrides;
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn with_node_type(self, node_type: NodeType<T>) -> Self {
        Self { node_type, ..self }
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn with_callbacks(self, callbacks: Vec<(EventFilter, Callback<T>)>) -> Self {
        Self { callbacks, ..self }
    }
    #[inline(always)]
    pub fn with_default_callback_ids(
        self,
        default_callback_ids: Vec<(EventFilter, DefaultCallbackId)>,
    ) -> Self {
        Self {
...
impl<T> PartialEq for Dom<T> {
    fn eq(&self, rhs: &Self) -> bool {
        self.arena == rhs.arena && self.root == rhs.root && self.head == rhs.head
    }
}
...
fn init_arena_with_node_data<T>(node_data: NodeData<T>) -> Arena<NodeData<T>> {
    ...
    Arena {
        ...
        node_data: NodeDataContainer {
            internal: vec![node_data],
        },
    }
}

fn print_tree_recursive<T>(
...
impl<T> Dom<T> {
    ...
    #[inline]
    pub fn gl_texture<I: Into<StackCheckedPointer<T>>>(
        callback: GlCallbackTypeUnchecked<T>,
        ptr: I,
    ) -> Self {
    ...
    #[inline]
    pub fn iframe<I: Into<StackCheckedPointer<T>>>(
        callback: IFrameCallbackTypeUnchecked<T>,
        ptr: I,
    ) -> Self {
    ...
    #[inline]
    pub fn with_default_callback_id<O: Into<EventFilter>>(
        mut self,
        on: O,
    ...
    pub fn add_callback<O: Into<EventFilter>>(&mut self, on: O, callback: CallbackType<T>) {
        self.arena.node_data[self.head]
            .callbacks
            .push((on.into(), Callback(callback)));
    }
    ...
    pub fn add_css_override<S: Into<DomString>, P: Into<CssProperty>>(
        ...
        self.arena.node_data[self.head]
            .dynamic_css_overrides
            .push((override_id.into(), property.into()));
    }
...
fn test_dom_sibling_1() {
    ...
    let dom: Dom<TestLayout> = Dom::new(NodeType::Div)
        .with_child(
    ...
    assert_eq!(
        vec![DomString::Static("sibling-1")],
    ...
    assert_eq!(
        vec![DomString::Static("sibling-2")],
    ...
    assert_eq!(
        vec![DomString::Static("sibling-1-child-1")],
        arena.node_data[arena.node_layout[arena.node_layout[dom.root]
            .first_child
            .expect("root has no first child")]
        .first_child
    ...
    assert_eq!(
        vec![DomString::Static("sibling-2-child-1")],
