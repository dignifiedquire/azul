use azul_css::{
    ColorU as StyleColorU, LayoutRect, LayoutSize, Overflow, PixelValue, StyleFontSize,
...
pub const DEFAULT_FONT_SIZE: StyleFontSize =
    StyleFontSize(PixelValue::const_px(DEFAULT_FONT_SIZE_PX));
pub const DEFAULT_FONT_ID: &str = "serif";
pub const DEFAULT_FONT_COLOR: StyleTextColor = StyleTextColor(StyleColorU {
    r: 0,
    b: 0,
    g: 0,
    a: 255,
...
pub struct PositionedRectangle {
    ...
    /// and store them here.
    pub resolved_text_layout_options:
        Option<(ResolvedTextLayoutOptions, InlineTextLayout, LayoutRect)>,
